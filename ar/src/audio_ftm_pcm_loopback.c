...
/**
  ...
  @file   audio_ftm_pcm_loopback.c
  @brief  AUDIO FTM Adie loopback driver
====================================================================================================
# Copyright (c) 2024-2025 Qualcomm Innovation Center, Inc. All rights reserved.
# SPDX-License-Identifier: BSD-3-Clause-Clear

$Header: //source/qcom/qct/multimedia2/Audio/drivers/ftm/8x60/linux/rel/1.0/src/audio_ftm_pcm_loopback.c#2 $
...
typedef struct Aud_FTM_DrvCtxt_S{
   ...
   DALSYSSyncHandle             hClientSync;
     ...
     AUD_FTM_PCM_LP_PARAM_T    client_param;       /* parameters passed from client */
...
)
{
  ...
  /************* Create Critical Section ***********/
   ...
   DALSYS_memcpy((uint8*)&(pDriverCtxt->client_param),
                  (uint8*)pParam, sizeof(AUD_FTM_PCM_LP_PARAM_T));
   ...
   hw_param.gain=pDriverCtxt->client_param.gain;
     ...
     hw_param.m_loopback_type=AUDIO_FTM_ADIE_LOOPBACK;
...
==================================================================================================*/
AUDIO_FTM_STS_T
audio_ftm_pcm_lp_read(AUDIO_FTM_CLIENT_HANDLE_T clientHandle, void *pBuffer, uint32 nBufSize, uint32 *pCount)
{
  return AUDIO_FTM_SUCCESS;
}
...
==================================================================================================*/
AUDIO_FTM_STS_T
audio_ftm_pcm_lp_write(AUDIO_FTM_CLIENT_HANDLE_T, void *, uint32 nBufSize)
{
  return AUDIO_FTM_SUCCESS;
...
)
{
  ...
  Aud_FTM_DevCtxt_T* pDevContext;
    ...
    if( (pDrvContext == NULL) || (pDrvContext->pDevCtxt == NULL))
    {
        return AUDIO_FTM_ERROR;
    }
