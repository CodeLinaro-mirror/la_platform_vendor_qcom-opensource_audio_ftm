...
)
{
  ...
  /************* Create Critical Section ***********/
    ...
    if(DAL_SUCCESS != DALSYS_SyncCreate(&(pDriverCtxt->hClientSync)))
    {
...
==================================================================================================*/
AUDIO_FTM_STS_T
audio_ftm_afe_lp_read(AUDIO_FTM_CLIENT_HANDLE_T clientHandle, void *pBuffer, uint32 nBufSize, uint32 *pCount)
{
  return AUDIO_FTM_SUCCESS;
}
...
==================================================================================================*/
AUDIO_FTM_STS_T
audio_ftm_afe_lp_write(AUDIO_FTM_CLIENT_HANDLE_T, void *, uint32 nBufSize)
{
  return AUDIO_FTM_SUCCESS;
...
)
{
    ...
    case IOCTL_AUDIO_FTM_STOP:
    {
        AFEDevAudIfDirType dir;
        dir=AUDIO_IF_SOURCE;
        audio_ftm_hw_iocontrol(pDevCtxt, IOCTL_AUDIO_FTM_STOP, (uint8 *)&dir, NULL);
  }
    break;
